...
class AddressList extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            StreetNumber: null, StreetNumbererror: false, showeditaddress: false,
            StateDDl1: [], CityDDl1: [], StateID1: null, CityID1: null,
            Address1: null, Addresserror1: false,
            Country1: null, Countryerror1: false,
            Pincode1: null, Pincodeerror1: false,
            Locality1: null, Localityerror1: false,
            StreetName1: null, StreetNameerror1: false,
            AdminArea1: null, AdminAreaerror1: false,
            StreetNumber1: null, StreetNumbererror1: false, AddressID: null,
            isOn1: false,
            isOn: false,
    ...
    async componentDidMount() {
        try {
            ...
            const addressResponse = await axios.get(URL_key + 'api/AddressApi/gCustomerAddress?UserProfileID=' + UserProfileID, {
            ...
            // Fetch all states
            const stateResponse = await axios.get(URL_key + 'api/AddressApi/gStateDDL', {
                headers: { 'content-type': 'application/json' }
            });
            ...
            const updatedAddresses = await Promise.all(
                AddressList.map(async (address) => {
                    // Find State Name
                    const state = StateDDl.find(state => state.StateID == address.StateID);
                    const StateName = state ? state.StateName : "Unknown";

                    // Fetch Cities for this state
                    const cityResponse = await axios.get(URL_key + 'api/AddressApi/gCityDDL?StateID=' + address.StateID, {
                        headers: { 'content-type': 'application/json' }
                    });
            ...
            <SafeAreaView>
                <ScrollView>
                        ...
                        <ScrollView style={{
                            ...
                            <Text
                                style={{
                                    ...
                                    fontSize: Normalize(12), marginBottom: hp('1%')
                                }}>
                                Road/Street/Building Name
                            </Text>
                            {this.state.StreetName1 == null || this.state.StreetName1 == undefined ? <>
                                <TextInput
                                    color={'#333'}
                                    fontFamily={'WorkSans-Regular'}
                            ...
                            {this.state.StreetNumber1 == null || this.state.StreetNumber1 == undefined ? <>
                                <TextInput
                                    color={'#333'}
                                    fontFamily={'WorkSans-Regular'}
                                    placeholderTextColor={'#666'}
                            ...
                            {this.state.Pincode1 == null || this.state.Pincode1 == undefined ? <>
                                <TextInput
                                    color={'#333'}
                                    fontFamily={'WorkSans-Regular'}
                                    placeholderTextColor={'#666'}
                            ...
                            <ToggleSwitch
                                ...
                                labelStyle={{
                                    fontFamily: 'WorkSans-Bold',
                                    fontSize: Normalize(12), marginLeft: wp('8%'),
                                }}
                                size="small"
                                onToggle={isOn => { this.setState({ isOn1: !this.state.isOn1 }) }}
                            />
                            <TouchableOpacity
                                activeOpacity={0.5}
                                onPress={() => {
                    ...
                    <Icon
                        ...
                        color={'#333'}
                        size={30}
                        style={{ marginLeft: wp('2%'), padding: hp('1.5%'), marginTop: hp('3%'), }}
                    />
                    ...
                    <View style={{ width: wp('100%'), backgroundColor: "#f2f2f2", height: hp('8%'), justifyContent: "center", marginTop: hp('2%') }}>
                        <Text
                            style={{
                                fontSize: 11,
                                // textAlign: "center",
                            ...
                            return (
                                <>
                                    <Icon
                                        ...
                                        name={item.AddressCategory == "Home" ? "home-outline" : item.AddressCategory == "Work" ? "business-outline" : "location-outline"}
                                        color={'#333'}
                                        size={25}
                                    ...
                                    <Text
                                        style={{
                                            ...
                                            marginTop: hp('0.5%'),
                                            // marginBottom: hp('1%'),
                                            marginLeft: wp('20%'), marginRight: wp('10%')
                                        }}>
                                    ...
                                    <View style={{ flexDirection: "row" }}>
                                        <Text
                                            ...
                                            style={{
                                                ...
                                                marginTop: hp('0.5%'),
                                                // marginBottom: hp('1%'),
                                                marginLeft: wp('20%'), marginRight: wp('3%')
                                            }}>
                                            EDIT
                                        </Text>
                                        <Text
                    ...
                    >
                        ...
                        <View style={{ width: wp('90%'), borderWidth: 1, height: hp('5%'), alignItems: "center", justifyContent: "center", borderColor: "#00afb5", marginTop: hp('2%'), alignSelf: "center" }}>
                            <Text
                                style={{
                                    color: '#00afb5',
                                    fontSize: 12,
                    ...
                    <RBSheet
                        ...
                        <ScrollView>
                            ...
                            <TextInput
                                ...
                                onChangeText={value =>
                                    this.handleInputChange('Pincode', value)
                                }
                                style={{
                                    height: hp('4.5%'),
                                    shadowColor: 'white',
