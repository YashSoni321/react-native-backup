...
class CategoryProduct extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            ChildSubCategoryID: this.props.route?.params?.data?.ChildSubCategoryID || null,
            ...
            <SafeAreaView>
                <ScrollView>
                    <ImageBackground
                        ...
                        <TouchableOpacity
                            ...
                            <Icon
                                ...
                                color={'#00afb5'}
                                size={40}
                                style={{ marginLeft: wp('3%'), padding: hp('1%'), marginTop: hp('-9%'), }}
                            />
                        </TouchableOpacity>
                    ...
                    <View
                        style={{
                            marginLeft: wp('4%'),
                            marginRight: wp('4%'), marginTop: hp('0%'), marginBottom: hp('2%')
                        }}>
                        <FlatList
                                                        ...
                                                        <>
                                                            <TouchableOpacity onPress={() => {
                                                                ...
                                                                <View
                                                                    ...
                                                                    {item.ProductImage == null || item.ProductImage == undefined || item.ProductImage == "" ? <>
                                                                        <Image
                                                                            style={{
                                                                                width: wp('39%'),
                                                                                height: hp('15%'),
