            ...
            <ScrollView>
                <View style={{ backgroundColor: "#ffffff" }}>
                    ...
                    <Text
                        ...
                        Shop your favorite styles and get them delivered instantly from local stores to your doorstep Fashion, delivered fast!
                    </Text>
                        ...
                        onPress={async () => {
                            try {
                                ...
                                if (locationResult === RESULTS.GRANTED) {
                                    ...
                                    Alert.alert("Permission Denied", "Location permission is required for the app to function properly!");
                                }
                            } catch (error) {
